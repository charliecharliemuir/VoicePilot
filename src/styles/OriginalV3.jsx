// ORIGINAL V3 - Friendly, human-centric, lifestyle imagery for real estate professionals
...
export default function OriginalV3() {
      ...
      for (const sectionId of sectionOrder) {
        ...
        if (ref.current) {
          ...
          if (rect.top <= checkPoint && rect.bottom >= checkPoint) {
            setCurrentSectionBg(SECTION_BACKGROUNDS_V3[sectionId]);
            return;
          }
        }
      }
  ...
  return (
    <div className="min-h-screen relative" style={{ background: "#FFFBF5", color: TOKENS.dark }}>
      ...
      <section ref={sectionRefs.hero} className="pt-6 pb-12 md:pt-10 md:pb-20 relative z-10 overflow-hidden hero-bounce-hint">
        ...
        `}</style>
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            {/* Imagery collage - lifestyle focused */}
      ...
      {/* TRUST STRIP - Personal testimonials */}
      <section
      ...
      <section ref={sectionRefs.preview} className="py-20 md:py-28 relative z-10" style={{ background: "#F8F5F0" }}>
        <div className="max-w-6xl mx-auto px-6 text-center">
          <BadgeV3>Interactive demo</BadgeV3>
          <h2 className="text-3xl md:text-4xl font-bold mt-4" style={{ fontFamily: '"DM Serif Display", Georgia, serif' }}>
            See VoicePilot in action
          </h2>
          <p className="mt-4 text-lg max-w-xl mx-auto" style={{ opacity: 0.7, fontFamily: '"Source Sans 3", system-ui' }}>
            Click through the conversation below to experience how natural dialogue becomes structured transactions.
          </p>
      ...
      <section ref={sectionRefs.how} id="how" className="py-20 md:py-28 relative z-10" style={{ background: "#FFFBF5" }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <BadgeV3>Simple as 1-2-3</BadgeV3>
            <h2 className="text-3xl md:text-4xl font-bold mt-4" style={{ fontFamily: '"DM Serif Display", Georgia, serif' }}>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            <StepCardV3 
              ...
              description="Speak about your deal the way you'd tell a colleague — we understand context, dates, and details."
              icon={Icons.mic}
            />
            <StepCardV3 
              number="2" 
              title="Watch it organize"
              description="VoicePilot extracts timelines, tasks, and form fields in real-time. No typing, no hunting for forms."
              icon={Icons.layers}
            />
            <StepCardV3 
              number="3" 
              title="Stay in control"
              description="Review, confirm, and adjust anything. Nothing happens without your approval."
              icon={Icons.check}
            />
          </div>
        </div>
      ...
      {/* WORKFLOWS - Animated journey section */}
      <section ref={sectionRefs.workflows} id="workflows" className="py-20 md:py-28 relative z-10 overflow-hidden" style={{ background: "#F8F5F0" }}>
        <WorkflowsJourneyV3 />
      </section>

      {/* COMPLIANCE - Reassurance section */}
      <section ref={sectionRefs.compliance} id="compliance" className="py-20 md:py-28 relative z-10" style={{ background: "#F0EDE6" }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <BadgeV3>Your license, protected</BadgeV3>
              <h2 className="text-3xl md:text-4xl font-bold mt-4" style={{ fontFamily: '"DM Serif Display", Georgia, serif' }}>
                Built for compliance,<br />designed for peace of mind
              </h2>
              <p className="mt-6 text-lg leading-relaxed" style={{ opacity: 0.75, fontFamily: '"Source Sans 3", system-ui' }}>
                VoicePilot was built by people who understand real estate transactions inside and out. We know the risks, and we've designed every feature to keep you compliant.
              </p>
              
              <div className="mt-8 space-y-4">
                <ComplianceItemV3 positive text="Supports your workflow — never replaces your judgment" />
                <ComplianceItemV3 positive text="Full audit trail of every conversation and action" />
                <ComplianceItemV3 positive text="Broker oversight tools built-in from day one" />
                <ComplianceItemV3 positive text="Assumptions are always labeled — you see what's inferred" />
              </div>
            </div>
              ...
              <div className="rounded-3xl overflow-hidden shadow-2xl" style={{ background: "white" }}>
                <div className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: "rgba(130,191,152,0.15)" }}>
                      {Icons.shield}
                    </div>
                    <div>
                      <p className="font-semibold">Compliance First</p>
                      <p className="text-sm opacity-60">Every feature reviewed</p>
                    </div>
                  </div>
                  
                  <div className="space-y-3">
                    <ComplianceItemV3 negative text="No legal advice — ever" muted />
                    <ComplianceItemV3 negative text="No autonomous document filing" muted />
                    <ComplianceItemV3 negative text="No bypassing broker review" muted />
                    <ComplianceItemV3 negative text="No hidden decisions" muted />
                  </div>
                </div>
              </div>
              
              {/* Decorative elements */}
              <div className="absolute -bottom-4 -right-4 w-24 h-24 rounded-full -z-10" style={{ background: TOKENS.soft, opacity: 0.5 }} />
              <div className="absolute -top-4 -left-4 w-16 h-16 rounded-full -z-10" style={{ background: TOKENS.accent, opacity: 0.2 }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section ref={sectionRefs.waitlist} id="waitlist" className="py-20 md:py-28 relative z-10" style={{ background: TOKENS.dark, color: "#FFFBF5" }}>
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="w-16 h-16 rounded-2xl mx-auto mb-8 flex items-center justify-center" style={{ background: "rgba(130,191,152,0.2)" }}>
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={TOKENS.accent} strokeWidth="2">
              <path d="M22 17H2a3 3 0 0 0 3-3V9a7 7 0 0 1 14 0v5a3 3 0 0 0 3 3zm-8.27 4a2 2 0 0 1-3.46 0" />
            </svg>
          </div>
          
          <h2 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: '"DM Serif Display", Georgia, serif' }}>
            Ready to try VoicePilot?
          </h2>
          <p className="mt-4 text-lg max-w-lg mx-auto" style={{ opacity: 0.75, fontFamily: '"Source Sans 3", system-ui' }}>
            We're rolling out in phases, starting with California. Join the waitlist and be the first to know when it's your turn.
          </p>
          ...
          <p className="mt-6 text-sm" style={{ opacity: 0.5 }}>
            No spam, ever. Just updates on your spot in line.
          </p>
        </div>
      </section>
...
function NavBarV3({ menuOpen, setMenuOpen }) {
  return (
        ...
        >
          ...
          <a href="#waitlist" onClick={() => setMenuOpen(false)} className="mt-3">
            <button 
              ...
              style={{ background: TOKENS.dark, color: "#FFFBF5" }}
            >
              Join Waitlist
            </button>
          </a>
...
function ImageCollageV3() {
  return (
    <div className="relative mx-auto" style={{ maxWidth: "480px" }}>
      ...
      <div className="absolute -bottom-8 -left-8 md:-left-16 scale-[0.55] origin-bottom-left">
        <PhoneMockV2 />
      </div>
      
      {/* Floating card */}
      <div 
        className="absolute top-4 -right-4 md:-right-8 px-4 py-3 rounded-2xl shadow-xl animate-float"
        style={{ background: "white" }}
      >
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: "rgba(130,191,152,0.15)" }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={TOKENS.accent} strokeWidth="2.5">
              <polyline points="20 6 9 17 4 12" />
            </svg>
          </div>
          <div>
            <p className="text-xs font-semibold" style={{ color: TOKENS.dark }}>Deposit confirmed</p>
            <p className="text-[10px] opacity-60">$36,000 received</p>
          </div>
        </div>
      </div>
      ...
      <div 
        className="absolute bottom-16 -right-4 md:-right-12 px-3 py-2 rounded-xl shadow-lg"
        style={{ background: TOKENS.accent }}
      >
        <p className="text-white text-xs font-medium">🎉 Just closed!</p>
      </div>
